...
const Home = () => {
 const githubLink = 'https://github.com/kzmfhm/my-portfolio';
  return (
    <>
    <Navbar/>
    <header class='h-auto md:pt-[-10px] md:flex overflow-hidden'>
    <div class='font-bold text-yellow-700 md:flex'>
      <img src={WomenImg}/>
     </div>
    <div class='section1'>
    <div class="md:mt-[20px] font-sans hover:font-serif p-10 rounded-xl md:pt-[100px] items-center space-x-4 h-[100px] w-[290px] font-bold md:h-[330px] md:w-[480px] text-white section1">
