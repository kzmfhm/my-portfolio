  ...
  return (
   ...
   <div className='left-block'>
    ...
    <h1 class='md:mx-[80px] font-sans hover:font-sans text-2xl cursor-pointer transition ease-in-out delay-150 hover:text-yellow-700  hover:-translate-y-1 hover:scale-110 duration-300 ...'>💫HI THERE! I'M
      ...
      <span data-text="KHUZAIMA">KHUZAIMA</span></h2>
      <h3 class='md:pl-[49px] pl:[50px] font-sans hover:font-sans md:pt-[10px] text-2xl cursor-pointer transition ease-in-out delay-150 hover:text-yellow-700  hover:-translate-y-1 hover:scale-110  duration-300 ...'>FRONTEND DEVELOPER</h3>
     </div>
     </Link>
     </div>
      {/* --------------Section2----------- */}
